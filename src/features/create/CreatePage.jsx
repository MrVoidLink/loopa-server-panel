...
const protocols = [
  { id: "xray", name: "XRay", icon: <Zap className="text-cyan-400" size={28} />, enabled: true },
  { id: "v2ray", name: "V2Ray", icon: <Shield className="text-emerald-400" size={28} />, enabled: false },
  { id: "openvpn", name: "OpenVPN", icon: <Lock className="text-blue-400" size={28} />, enabled: false },
  { id: "wireguard", name: "WireGuard", icon: <Link2 className="text-yellow-400" size={28} />, enabled: false },
  { id: "openconnect", name: "OpenConnect", icon: <Globe className="text-purple-400" size={28} />, enabled: false },
];
  ...
  return (
    <div
      className="relative h-full p-6 
                 overflow-y-auto md:overflow-hidden   /* 👈 موبایل: اسکرول / دسکتاپ: ثابت */
      ...
      <div className="relative z-10">
        ...
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 tracking-tight">
            Create <span className="text-[var(--accent)]">New Server</span>
          </h1>
          ...
          {protocols.map((p) => {
            ...
            return (
              ...
              >
                ...
                {disabled && <div className="absolute inset-0 rounded-2xl backdrop-blur-[1px]" />}
              </div>
            );
          })}
        </div>
